...
import { ForgotPasswordForm, NewPasswordFormData, User, UserLoginForm, UserRegistrationForm } from "@/types";
...
export const getUser = async () => {
    return await makeSafeRequest<User>(() => uptaskApi.get('/auth/user'))
}